...
use are 
RSpec~\uf{rspec.info} for unit testing; 
SimpleCov for C0 test coverage; 
Cucumber~\uf{cukes.info} for behavior-driven design and integration testing; 
Pivotal Tracker~\uf{pivotaltracker.com} for lightweight project management;
Travis~\uf{travis-ci.org} for continuous-integration testing; 
CodeClimate~\uf{codeclimate.com} for code-quality metrics;
and, of course, GitHub~\uf{github.com} at the center, with which all the
